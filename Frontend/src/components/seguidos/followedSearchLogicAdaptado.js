    ...
    export const searchByFilter = (filter , array) =>{ //función para buscar usuarios por nombre
      return array.filter(user => user.username.first.toUpperCase().includes(filter.toUpperCase())); //filtramos los usuarios por nombre
    }
