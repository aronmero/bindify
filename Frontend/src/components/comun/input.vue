<script setup>
    ...
    // Variable que define las propiedades que serán recibidas por el componente
    ...
    // Variable que define los eventos personalizados que puede emitir el componente
    const emit = defineEmits(["datos"]);

    // URLs de las imágenes para el ojo abierto y cerrado
    ...
    const ojo = ref("/assets/icons/eye.svg");   // Variable reactiva para el icono del ojo


    // Función para cambiar entre la visión de contraseña visible e invisible
    ...
    // Variable reactiva para la imagen seleccionada
