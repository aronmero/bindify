...
<template>
    <div class="flex flex-col gap-y-2">
        ...
        <input @change="emitirDatos" v-if="(tipo == 'text' || tipo == 'password') && img != null" :type="tipo" class="ps-12 bg-background-100 text-text-950 py-3 px-1 rounded-xl" :placeholder="placeholder" :value="valor">
        <input @change="emitirDatos" v-if="(tipo == 'text' || tipo == 'password') && img == null" :type="tipo" class="ps-3 bg-background-100 text-text-950 py-3 px-1 rounded-xl" :placeholder="placeholder" :value="valor">
