...
import { en_favoritos } from '@/components/feed_media/helpers/favoritos';

import Comentarios from '@/components/feed_media/modal/ComentariosHome.vue';
...
@import '@/components/feed_media/styles/sass/variables.scss';
