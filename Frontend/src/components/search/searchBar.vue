...
<template>
    ...
    <input class="w-full py-2 px-4 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 bg-[#f3f2f2]" type="search" :placeholder="'buscar ' + placeholder + '...'" v-model="searchValue" @input="searchElement" @keyup.enter="scrollToSectionResults">
