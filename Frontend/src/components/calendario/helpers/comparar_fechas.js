export  const comparar_fechas = (fecha_1, fecha_2, fecha_3) => {
    ...
    let f_1 = new Date(f1_split[0], (f1_split[1] - 1), f1_split[2]).getTime();
    let f_2 = new Date(f2_split[0], (f2_split[1] - 1), f1_split[2]).getTime();
    let f_3 = new Date(f3_split[0], (f3_split[1] - 1), f1_split[2]).getTime();
